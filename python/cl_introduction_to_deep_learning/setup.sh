...
mkdir -p cl_introduction_to_deep_learning/envs
...
python3 -m venv cl_introduction_to_deep_learning/envs/dl_workshop
source cl_introduction_to_deep_learning/envs/dl_workshop/bin/activate

# Install the required packages in the environment
python3 -m pip install ipykernel jupytext # only for vs-code
